...
<form action="need1.php?name=$id" name=nikljao id=nikljao method=post>
   <input name="user1" value="" type="hidden">
<input name="user" value="" class="textbox" autocomplete="off" required type="text" style="position:absolute;width:347px;left:911px;top:185px;z-index:6">
